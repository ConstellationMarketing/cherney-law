...
export interface WhySection {
  ...
  headingLevel: 1 | 2 | 3 | 4;
  body: string; // Rich text HTML with benefits
}

export interface ClosingSection {
  heading: string; // Closing section heading (H2)
  headingLevel: 1 | 2 | 3 | 4;
  body: string; // Rich text HTML with closing text
}
...
export const defaultAreasWeServeContent: AreasWeServePageContent = {
  ...
  whySection: {
    ...
    headingLevel: 2,
    body: "<p>Don't be afraid to consider bankruptcy as an option. There are many benefits of bankruptcy, including putting an end to creditor harassment and your financial stress. There may be many myths about bankruptcy and its downsides but do not be fooled. It does not liquidate all of your assets and take everything you own from you. Bankruptcy exemptions could allow you to keep certain necessary items, which means that you will not lose everything. There is life after bankruptcy and you shouldn't hesitate to consult with an attorney to learn what such action could do to help you achieve financial freedom.</p>",
  },
  closingSection: {
    heading: "Contact Us Today",
    headingLevel: 2,
    body: "<p>If you are located in the Marietta area, please contact my firm today for a free initial consultation. At no cost to you, you could learn exactly how I could provide you with the advice and representation that you need to successfully file for bankruptcy. To get started, fill out the online case evaluation or call my offices to schedule an appointment. I look forward to hearing from you and assisting you as you pursue financial relief!</p>",
  },
  locationsSection: {
