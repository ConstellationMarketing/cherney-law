...
function HeadingRenderer({ text, level }: { text: string; level: 1 | 2 | 3 | 4 }) {
  const classes: Record<number, string> = {
    1: "font-playfair text-[36px] md:text-[54px] lg:text-[64px] leading-tight md:leading-[64px] text-black pb-[20px] md:pb-[30px]",
    2: "font-playfair text-[32px] md:text-[42px] lg:text-[48px] leading-tight md:leading-[48px] text-black pb-[20px] md:pb-[30px]",
    3: "font-playfair text-[28px] md:text-[36px] lg:text-[42px] leading-tight md:leading-[42px] text-black pb-[20px] md:pb-[30px]",
    4: "font-playfair text-[24px] md:text-[32px] lg:text-[36px] leading-tight md:leading-[36px] text-black pb-[20px] md:pb-[30px]",
  };
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-[4%]">
            ...
            <div className="lg:col-span-3 space-y-8">
              ...
              <div>
                ...
                <BodyContent html={content.introSection.body} />
              </div>

              {/* Intro Section Image (full-width) */}
              {content.introSection.image && (
          ...
          <div className="max-w-[2560px] mx-auto w-[95%] md:w-[90%] lg:w-[80%]">
            ...
            <div className="w-full overflow-hidden rounded-lg">
              <iframe
                ...
                title={content.mapSection.heading || "Service area map"}
              />
            </div>
          </div>
        </div>
