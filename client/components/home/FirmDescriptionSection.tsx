      ...
      <div className="max-w-[2560px] mx-auto w-[95%] md:w-[90%]">
        <div className="bg-[#C8D9AD] py-[40px] md:py-[60px] px-[30px] md:px-[60px] lg:px-[100px]">
          <div className="max-w-[900px] mx-auto text-center">
            ...
            <p className="font-outfit text-[14px] md:text-[16px] leading-[1.7] text-[#2a2a2a] mb-[20px] md:mb-[25px]">
            ...
            <p className="font-outfit text-[14px] md:text-[16px] leading-[1.7] text-[#2a2a2a]">
