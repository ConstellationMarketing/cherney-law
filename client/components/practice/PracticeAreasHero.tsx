import type { PracticeAreasHeroContent } from "@site/lib/cms/practiceAreasPageTypes";
import { Phone } from "lucide-react";

interface PracticeAreasHeroProps {
  content: PracticeAreasHeroContent;
  phoneDisplay: string;
  phoneLabel: string;
}
      ...
      <div className="max-w-[2560px] mx-auto w-[95%] md:w-[90%]">
        <div className="flex flex-col md:flex-row md:items-center gap-6 md:gap-8">
          ...
          <div className="flex-1">
            ...
            {content.subtext && (
              <p className="font-outfit text-[16px] md:text-[18px] leading-[24px] md:leading-[28px] text-black/80 mt-[15px] max-w-[800px]">
                {content.subtext}
              </p>
            )}
          </div>
