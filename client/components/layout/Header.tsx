        ...
        <div className="max-w-[2560px] w-[95%] mx-auto bg-[#161715] border border-law-border px-[30px] py-[10px] flex items-center justify-between">
            ...
            <div className="hidden md:block w-[280px]">
              <Link to={settings.headerCtaUrl}>
                <Button className="bg-white text-black font-outfit text-[22px] h-[50px] px-[15.4px] w-[200px] border-2 border-transparent hover:border-black hover:bg-law-accent hover:text-white transition-all duration-300 flex items-center justify-center gap-2">
              ...
              >
                <nav className="flex flex-col gap-4 mt-8">
                  ...
                  <Link to={settings.headerCtaUrl} className="mt-4">
                    <Button className="bg-white text-black font-outfit text-[22px] h-[50px] w-full border-2 border-transparent hover:border-black hover:bg-law-accent hover:text-white transition-all duration-300 flex items-center justify-center gap-2">
                      {settings.headerCtaText}
                      <ArrowRight className="w-5 h-5 group-hover:text-white" />
                    </Button>
                  </Link>
